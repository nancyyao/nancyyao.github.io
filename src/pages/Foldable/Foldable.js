        ...
        <StickyContainer>
          ...
          <Grid fluid styles={styles.grid}>
            <Row className="detail-row">
              ...
              skills="CAD (SolidWorks), Sketching, Prototyping, User research/testing"
            ...
            <Row className="detail-row">
              <Col xs={6} style={styles.col}>
                <Caption side="caption-left" header="Optimizing in the kitchen"
                 text=<p>Foldable aims to solve a problem that many university students and others face:
                 how might we inspire apartment dwellers with limited space to optimize
                 their kitchen use by saving space and cooking more often?</p>/>
              </Col>
               <Col xs={6} style={styles.col}>
            ...
            <Row className="detail-row">
               ...
               <Col xs={6} style={styles.col}>
                 <Caption side="caption-left" header="Solving common complaints"
                  ...
                  to pull-out counters (concept sketches above), but based on feedback from students, the
                  winning idea was multi-tasking dinnerware.<br/><br/>Multi-purpose dinnerware would save space
                  and time spent dishwashing by reducing the supplies needed to cook.</p>/>
               </Col>
            </Row>
